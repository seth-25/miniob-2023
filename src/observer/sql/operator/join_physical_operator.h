...
class CacheNestedLoopJoinPhysicalOperator : public PhysicalOperator
{
public:
  CacheNestedLoopJoinPhysicalOperator();
  virtual ~CacheNestedLoopJoinPhysicalOperator() = default;

  PhysicalOperatorType type() const override
  {
    return PhysicalOperatorType::CACHE_NESTED_LOOP_JOIN;
  }
