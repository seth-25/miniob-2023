...
FieldMeta::FieldMeta() : id_(-1), attr_type_(AttrType::UNDEFINED), attr_offset_(-1), attr_len_(0), nullable_(false), visible_(false)
{}

FieldMeta::FieldMeta(int id, const char *name, AttrType attr_type, int attr_offset, int attr_len, bool nullable, bool visible)
{
  [[maybe_unused]] RC rc = this->init(id, name, attr_type, attr_offset, attr_len, nullable, visible);
...
{
  os << "field id=" << id_ << ", field name=" << name_ << ", type=" << attr_type_to_string(attr_type_) << ", len=" << attr_len_
