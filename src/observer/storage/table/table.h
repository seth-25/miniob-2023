...
public:
  ...
  RC make_record_from_old_record(std::vector<const FieldMeta*>& fields, std::vector<const Value *>& values, Record& old_record, Record &new_record);
  ...
  // TODO refactor
  RC create_index(Trx *trx, bool is_unique, std::vector<const FieldMeta*>& field_metas, const char *index_name);
