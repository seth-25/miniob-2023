...
RC Table::create(int32_t table_id, const char *meta_path, const char *name, const char *base_dir, int attribute_count,
...
//                name(), rc2, strrc(rc2));
//    }
    RC rc2 = record_handler_->delete_record(&record.rid(), &table_meta_);
    if (rc2 != RC::SUCCESS) {
